              ...
              {selectedConversation ? (
                ...
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <h3 className="text-lg font-medium mb-2">Select a student to start chatting</h3>
                    <p className="text-sm">Choose a student from the list to begin a conversation</p>
                  </div>
                </div>
              )}
            </div>
